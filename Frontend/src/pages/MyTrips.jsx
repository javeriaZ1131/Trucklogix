      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
            Manage and view all your planned and historical trips.
          </p>
        </div>
        <button
          onClick={() => navigate('/new-trip')}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
        ...
        {!loading && trips.length === 0 && (
          <div className="py-12 text-center">
            <p className="text-gray-400 text-sm mb-3">No trips found.</p>
            <button
              onClick={() => navigate('/new-trip')}
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100 dark:border-gray-700">
                  {['Trip ID', 'Route', 'Date', 'Distance', 'Duration', 'Status', 'Actions'].map(h => (
                    <th key={h} className="text-left px-5 py-3 text-xs font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wider">
                      {h}
                    </th>
                  ))}
                </tr>
              ...
              <tbody className="divide-y divide-gray-50 dark:divide-gray-700/50">
                {trips.map(trip => {
                  // ✅ API uses snake_case + result.distance
